...
## Data Availability
The datasets required to run the scripts are archived on Zenodo:
DOI: **https://doi.org/10.5281/zenodo.18884891**
The archive contains the processed spatial datasets used for SOC modelling, including climate forcings, LUH2 land-use forcings, and other static geoenvironmental features required to reproduce the simulations.
